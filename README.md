...
If you wish to replicate this project, you can follow these steps to set up the environment:
...
1.  Ensure you have Docker installed on your system. For installation instructions, refer to the [Docker documentation](https://docs.docker.com/get-docker/).
...
Here, we provide three methods for processing SEM images: one using the command line, another using Docker, and the third using a Jupyter Notebook.
